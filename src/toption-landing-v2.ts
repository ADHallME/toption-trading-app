...
export default function LandingPage() {
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      price: "$39",
      period: "month",
      description: "For serious theta gang traders",
      features: [
  ...
  const testimonials = [
    {
      name: "Michael C.",
      role: "Theta Gang Trader",
      content: "Finally found consistent 20%+ monthly returns. The AI screening saves me 3+ hours daily.",
      rating: 5
    },
    {
      name: "Sarah K.", 
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="text-xs text-slate-400 font-medium -mt-1 tracking-wider">
                  CURATED OPTIONS
                </div>
              </div>
            </div>
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="text-2xl text-gray-300 mb-4 font-medium">
            Actionable Insights. Trusted Analysis. Faster Decisions.
          </div>
